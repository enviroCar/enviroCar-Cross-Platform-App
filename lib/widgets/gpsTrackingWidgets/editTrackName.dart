  ...
  Widget build(BuildContext context) {
    return SingleChildScrollView(
      child: CustomContainer(
        ...
        progress: 0.7,
        child: Container(
          margin: EdgeInsets.symmetric(vertical: deviceHeight * 0.16, horizontal: deviceWidth * 0.1),
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          TrackDetailsTile(
                              title: 'no of stops',
                              subTitle: widget.gpsTrackProvider.getNoOfStops.toString()
                          ),
                        ],
                      ),
                    ),
                      ...
                      child: Button(
                          ...
                          onTap: () {
                            if (_key.currentState.validate()) {
                              ...
                              final LocalTrackModel track = widget.gpsTrackProvider.getLocalTrack(sensorId: "1"); // todo: change the hardcoded value "carsProvider.getSelectedCar.id.toString()"
...
class CustomContainer extends StatelessWidget {
  ...
  const CustomContainer({@required this.progressColor, @required this.height, @required this.progress, @required this.child});
