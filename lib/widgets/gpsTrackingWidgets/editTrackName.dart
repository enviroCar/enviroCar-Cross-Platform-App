      ...
      child: CustomContainer(
        ...
        child: Container(
          margin: EdgeInsets.symmetric(
              vertical: deviceHeight * 0.16, horizontal: deviceWidth * 0.1),
                      ...
                      child: Column(
                        ...
                        children: [
                          TrackDetailsTile(
                              title: 'start',
                              subTitle:
                                  widget.gpsTrackProvider.getTrackStartTime),
                          TrackDetailsTile(
                              title: 'end',
                              subTitle:
                                  widget.gpsTrackProvider.getTrackEndTime),
                          ...
                          TrackDetailsTile(
                              title: 'Duration',
                              subTitle:
                                  widget.gpsTrackProvider.getTrackDuration),
                          TrackDetailsTile(
                              title: 'no of stops',
                              subTitle: widget.gpsTrackProvider.getNoOfStops
                                  .toString()),
                        ],
                      ),
                    ),
