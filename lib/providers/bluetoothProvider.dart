...
class BluetoothProvider extends ChangeNotifier {
  ...
  void populateList(DiscoveredDevice discoveredDevice) {
    // TODO: add only OBD-II devices to the detected bluetooth devices list
  ...
  /// function to stop scanning by de-initializing [_flutterReactiveBle]
  void stopScan() {
  ...
  Future<bool> connectToDevice(
      DiscoveredDevice selectedDevice, BuildContext ctx, int index) async {
    context = ctx;
    _flutterReactiveBle
        .connectToDevice(
        ...
        .listen(sendConnectionStatusUpdates)
        .onError(handleError);
  ...
  void sendConnectionStatusUpdates(
      ConnectionStateUpdate connectionStateUpdate) {
    debugPrint('connected to ${connectedBluetoothDevice.id}');
    debugPrint(
        'connection state ${connectionStateUpdate.connectionState.toString()}');
  ...
  Future readCharacteristic(Uuid serviceId, Uuid characteristicId) async {
    ...
    final List<int> response = await _flutterReactiveBle
  ...
  Future writeCharacteristic(
      Uuid serviceId, Uuid characteristicId, List<int> byteArray) async {
    _flutterReactiveBle = FlutterReactiveBle();
    final QualifiedCharacteristic qualifiedCharacteristic =
        QualifiedCharacteristic(
            characteristicId: characteristicId,
